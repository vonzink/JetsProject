...
public class Drone extends Jet implements CombatReady{
	...
	public Drone(String jetName, String model, double speed, double range, long price, int armor, long payload, String pilot) {
		super("Drone", jetName, model, speed, range, price, armor, payload, pilot);
	}
